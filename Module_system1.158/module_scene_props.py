...
#  ("Baggage",sokf_place_at_origin|sokf_entity_body,"package","bobaggage"),
  ...
  ("castle_tower_d",0,"SO_tower_d","bo_SO_tower_d", []),
  ("castle_tower_e",0,"SO_tower_e","bo_SO_tower_e", []),
  ("castle_tower_f",0,"SO_tower_f","bo_SO_tower_f", []),
  
  ("castle_keep_a",0,"SO_keep_a","bo_SO_keep_a", []),
  ("castle_keep_b",0,"SO_keep_b","bo_SO_keep_b", []),
  ("castle_Gatehouse_a",0,"SO_gatehouse_a","bo_SO_gatehouse_a", []),
