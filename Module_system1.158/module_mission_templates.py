...
mission_templates = [
	("town_default",0,-1,
	 "Default town visit",[
		...
		(41,mtef_visitor_source,af_override_horse|af_override_gloves,0,1,[]),#41
		(42,mtef_visitor_source,af_override_horse|af_override_gloves,0,1,[]),#42
		(43,mtef_visitor_source,af_override_horse|af_override_gloves,0,1,[]),#43
	 ],[
		dedal_tavern_animations,
		#dedal end
      (1, 0, ti_once, [], 
